...
This project showcases Deep Learning methods of developing a model that recognizes commands such as right, up, left, etc. with an accuracy of ~90%

The project comes from a kaggle competition and was picked as a Final exam substitution in order to build and apply the skills learned in class.

https://www.kaggle.com/c/tensorflow-speech-recognition-challenge/notebooks

The processing of audio data involved use of Mel-Frequency Cepstral Coefficients (MFCC) and the final model used on the transformed data for training was a Convolutional Neural Network (CNN). Please see the report document for more details.

**Note:** 
The work on increasing accuracy was continued after the report was submitted thus, some screenshots of tests show a higher accuracy.
